...
# folder names
PHOTO_BASE_FOLDER = r"h:\\__ Photos"
FOLDER_TO_BE_SORTED = "____Photos to be sorted"
...
FOLDER_UNSORTED = "____UNSORTED IMAGES"
FOLDER_PROBLEMATIC = "__PROBLEMATIC"
FOLDER_PROBLEMATIC_OLD_EXIF = join("__PROBLEMATIC", "old_EXIF")
FOLDER_READY = "__READY"
READY_PHOTOS_SOURCE_FOLDER_FULL_PATH = join(PHOTO_BASE_FOLDER, FOLDER_TO_BE_SORTED, FOLDER_READY)
FOLDER_ORGANISER_WORKING_FOLDER = join(READY_PHOTOS_SOURCE_FOLDER_FULL_PATH, "___WORKING_FOLDER")
...
FOLDERS_RAW = [FOLDER_CR2_CONV, FOLDER_CRW_CONV, FOLDER_MPO_CONV, FOLDER_ARW_CONV, FOLDER_RW2_CONV, FOLDER_DNG_CONV]
FOLDERS_RESULT = FOLDERS_RAW + [FOLDER_ORIG_JPG, FOLDER_SORT_READY, FOLDER_EXTRACTED_JPG]
